...
public class PluginSettingsTab extends SimpleCustomTab{
	...
	public PluginSettingsTab(@NotNull final SBuildServer server,
		...
		super(webControllerManager,
				...
				"acunetixPluginSettings",
				scanRunType.getPluginSettingsJspFilePath(),
				"Acunetix 360");
		...
		webControllerManager.registerController(ScanConstants.PLUGIN_SETTINGS_RELATIVE_URL, new PluginSettingsController(server, pluginSettingsManager));
	}
