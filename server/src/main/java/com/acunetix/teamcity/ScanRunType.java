...
public class ScanRunType extends RunType{
	...
	public String getDisplayName() {
		return "Acunetix 360 Scan";
	}
	
	@NotNull
	@Override
	public String getDescription() {
		return "Build runner that starts Acunetix 360 scan for your site.";
	}
	...
	public String getPluginSettingsJspFilePath() {
		return pluginDescriptor.getPluginResourcesPath() + "acunetixPluginSettings.jsp";
	}
